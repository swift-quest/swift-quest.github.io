...
おや、 <code class="sq-output">MP 25</code> と <code class="sq-output">まおうのこうげき。</code> が詰まっていて見た目が良くないですね。間に 1 行空けたいところです。

空行を表示するには `print()` と書きます。
...
ちゃんと <code class="sq-output">MP 25</code> と <code class="sq-output">まおうのこうげき。</code> の間に空行を表示することができました。
